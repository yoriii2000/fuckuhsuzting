...
shutil.rmtree('/Users/yxc/研究所/Layering/each layer')
shutil.rmtree('/Users/yxc/研究所/Layering/Layertraj')
os.makedirs('/Users/yxc/研究所/Layering/each layer')
os.makedirs('/Users/yxc/研究所/Layering/Layertraj')
...
for part_no in range(0, len(ref_file)):
    ...
    BPoint, NPoint, total_layer = Lyr.Layering(NewPoint, NewPointIdx, NewNormal, tree, Vertice2, LayerDepth=Layer_height,
    ...
    print('[Running Program Duration:', int((Prog_end_time - Prog_start_time) / 60), 'minutes',
          int((Prog_end_time - Prog_start_time) % 60), 'seconds]')
