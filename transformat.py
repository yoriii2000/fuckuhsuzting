...
def demo_manual_registration(source):
    ...
    print('picked_id_source', type(picked_id_source))
    print('picked_id_source', picked_id_source)

    # picked_id_target = pick_points(target)

    # # picked_id_source = source[0:3, :2]
    # # picked_id_target = target[0:3, :2]
    # print('picked_id_source =', picked_id_source)
